...
export const MOCK_WORKFLOW_INSTANCES: WorkflowInstance[] = [
  { id: 1, companyId: COMPANY_ID, workflowDefinitionId: 1, subjectType: "RecurringTemplate", subjectId: 3, currentStep: 0, status: "Pending", requestedBy: "preview@vyron.local", createdAt: "2026-08-01T09:00:00Z" },
];
