...
export const MOCK_ASSET_CLASSES: AssetClass[] = [
  { id: 1, companyId: COMPANY_ID, name: "Vehicles", code: "VEH", defaultDepreciationMethod: "StraightLine", defaultUsefulLifeMonths: 60, isActive: true, createdAt: "2022-01-01T09:00:00Z", ...NO_GL_OVERRIDES },
  { id: 2, companyId: COMPANY_ID, name: "Office Equipment", code: "OFF", defaultDepreciationMethod: "DiminishingBalance", defaultUsefulLifeMonths: 36, isActive: true, createdAt: "2022-01-01T09:00:00Z", ...NO_GL_OVERRIDES },
  { id: 3, companyId: COMPANY_ID, name: "Warehouse Equipment", code: "WHE", defaultDepreciationMethod: "StraightLine", defaultUsefulLifeMonths: 48, isActive: true, createdAt: "2022-01-01T09:00:00Z", ...NO_GL_OVERRIDES },
];
