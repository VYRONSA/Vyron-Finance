...
// Phase 20B — Preview Mode has no Supabase Storage to generate a real
// signed URL from, so this mirrors every other tab's empty state rather
// than fabricating a fake logo image.
export const MOCK_COMPANY_BRANDING: CompanyBrandingAssets = {
  hasLogo: false, logoUrl: null, logoFilename: null, logoMimeType: null, logoSizeBytes: null, updatedAt: null,
};
...
export const MOCK_COMPANIES_FULL: Company[] = [
  {
    ...
    email: "accounts@fenwickrowe.co.za", website: "www.fenwickrowe.co.za", postalAddress: "PO Box 1234, Cape Town, 8000",
    city: "Cape Town", province: "Western Cape", postalCode: "8000", country: "South Africa",
  },
  {
