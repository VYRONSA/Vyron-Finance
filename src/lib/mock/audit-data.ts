...
/** Finding #158 — preview-mode stand-in for `listCompanyMembersWithEmail`
 * (a real Supabase Auth Admin API call in production, not something
 * Preview Mode can call). */
export const MOCK_COMPANY_MEMBERS = [
  { userId: "00000000-0000-0000-0000-000000000001", email: "t.nkosi@vyronfinance.example" },
  { userId: "00000000-0000-0000-0000-000000000002", email: "j.adams@vyronfinance.example" },
];
