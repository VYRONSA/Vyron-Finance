...
export const MOCK_BANK_RECONCILIATIONS: BankReconciliation[] = [
  {
    ...
    statementPeriodStart: "2026-07-01", statementOpeningBalance: 380000,
  ...
  },
  {
    ...
    statementPeriodStart: "2026-07-16", statementOpeningBalance: 397650.75,
...
export const MOCK_RECONCILIATION_SUMMARY: ReconciliationSummary = buildReconciliationSummary(
  ...
  412650.75,
  409250.75,
  // Matches MOCK_BANK_RECONCILIATIONS' in-progress session (502) so the
  // preview shows a real period and a real opening balance, not a
  // reconciliation starting from zero.
  { periodStart: "2026-07-16", statementOpeningBalance: 397650.75, reconciliationId: 502 },
);
