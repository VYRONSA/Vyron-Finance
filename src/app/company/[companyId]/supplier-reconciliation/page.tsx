        ...
        <CardContent className="relative flex flex-wrap items-center justify-between gap-6 p-8 lg:p-10">
          <div>
            ...
            <p className="mt-1.5 text-sm text-vf-on-dark-soft">
              Import, match, allocate, and report on supplier payments — all matched against this
              company&apos;s own bills and transactions, not against a supplier-provided statement of account
              (that capability doesn&apos;t exist yet).
            </p>
          </div>
          <GenerateReportsButton companyId={companyId} suppliers={suppliers} previewMode={previewMode} />
        </CardContent>
      </Card>
