...
export default async function PurchasingPage({ params }: { params: Promise<{ companyId: string }> }) {
  ...
  const [suppliers, vatTreatments, requisitions, orders, grns, bills, payments, chartOfAccounts, costCentres, projects, departments, stockItems, bankAccounts] = previewMode
    ? [
        MOCK_SUPPLIERS,
        MOCK_VAT_TREATMENTS,
        MOCK_PURCHASE_REQUISITIONS,
