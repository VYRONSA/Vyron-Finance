...
import { LIST_CAP as STOCK_ITEMS_LIST_CAP } from "@/server/repositories/stock-item-repository";
...
export default async function InventoryPage({ params }: { params: Promise<{ companyId: string }> }) {
  ...
  const stockItemsCapped = !previewMode && stockItems.length >= STOCK_ITEMS_LIST_CAP;
  ...
  return (
    <div className="flex w-full flex-col gap-6">
      ...
      <InventoryTabs
        ...
        stockItemsCapped={stockItemsCapped}
