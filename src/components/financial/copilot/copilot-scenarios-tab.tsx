...
function ScenarioCard({ companyId, scenario, previewMode }: { companyId: string; scenario: CopilotScenario; previewMode: boolean }) {
  ...
  // Finding #250 (RC-3) — mirrors the established `ConfirmActionRow`/
    ...
    <div className="rounded-vf-md border border-vf-paper-border p-4">
      <div className="flex items-center justify-between gap-2">
        ...
        {deleteConfirm.isConfirming(true) ? (
          <ConfirmActionRow message="Delete this scenario?" loading={loading} tone="danger" onConfirm={remove} onCancel={deleteConfirm.cancel} />
        ) : (
