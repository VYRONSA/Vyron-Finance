            ...
            <TableBody>
              {filtered.map((e) => (
                <TableRow key={e.id}>
                  ...
                  <TableCell className="text-right font-mono tabular-nums">{e.debit > 0 ? formatMoney(e.debit, currencyFor(e)) : ""}</TableCell>
                  <TableCell className="text-right font-mono tabular-nums">{e.credit > 0 ? formatMoney(e.credit, currencyFor(e)) : ""}</TableCell>
                  <TableCell>
                    {e.journalId ? (
