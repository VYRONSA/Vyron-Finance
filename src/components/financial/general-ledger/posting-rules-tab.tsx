  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="flex flex-wrap items-center gap-2">
         ...
         * (`posting-rule-service.ts`) never has to be imported into this
         * client component. */}
      ...
      <p className="text-xs text-vf-ink-faint">
        Download the template, complete it, and upload it here. One row per posting line —{" "}
        <span className="font-medium text-vf-ink-soft">Event Type, Side, Role, and Amount Source</span> are required.
        {" "}Line Order: whole number (leave blank to use the row&rsquo;s position within its Event Type).
      </p>
