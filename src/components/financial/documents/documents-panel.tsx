...
export function DocumentsPanel({
  ...
  // Master Implementation Tracker — Epic E11, Finding #228. Delete used to
  // fire immediately on click with no confirmation.
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-2">
                    ...
                    {confirmDelete.isConfirming(doc.id) ? (
                      ...
                      <div className="flex flex-wrap items-center gap-1.5">
                        ...
                        <Button variant="subtle" size="sm" onClick={() => confirmDelete.request(doc.id)} disabled={previewMode} title={disabledTitle} className="hover:border-vf-danger hover:text-vf-danger">
                          Delete
                        </Button>
                      </div>
                    )}
