...
function LogTab({ companyId, communications, capped, previewMode }: { companyId: string; communications: CommunicationRecord[]; capped: boolean; previewMode: boolean }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Finding #063 (RC-6) — the log was capped at 500 with no
  ...
  return (
    <Card>
      ...
      <CardContent className="pt-5">
        ...
        {activeTab === "Log" && <LogTab companyId={companyId} communications={communications} capped={communicationsCapped ?? false} previewMode={previewMode} />}
