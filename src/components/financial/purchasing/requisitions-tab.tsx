                      ...
                      <div className="flex flex-wrap justify-end gap-1.5">
                        {r.status === "Draft" && (
                          <>
                            ...
                            {cancelConfirm.isConfirming(r.id) ? (
                              <ConfirmActionRow message="Cancel this requisition?" confirmLabel="Confirm" confirmingLabel="Cancelling…" loading={loadingId === r.id} tone="danger" size="sm" onConfirm={() => runAction(r.id, "cancel")} onCancel={cancelConfirm.cancel} />
                            ) : (
                              <Button variant="subtle" size="sm" disabled={previewMode || loadingId === r.id} title={disabledTitle} onClick={() => cancelConfirm.request(r.id)}>
                                Cancel
                              </Button>
                            )}
                          </>
                        ...
                        {r.status === "Rejected" && (
                          ...
                          <Button variant="subtle" size="sm" disabled={previewMode || loadingId === r.id} title={disabledTitle} onClick={() => runAction(r.id, "clone-as-draft")}>
                            Clone as Draft
                          </Button>
                        )}
                      </div>
                  ...
                  {isExpanded && (
                    <TableRow>
                      <TableCell colSpan={7} className="bg-vf-paper-alt/40">
                        ...
                        <div className="mt-3">
                          <DocumentsPanel companyId={companyId} entityType="PurchaseRequisition" entityId={r.id} previewMode={previewMode} />
                        </div>
                      </TableCell>
                    </TableRow>
                  )}
