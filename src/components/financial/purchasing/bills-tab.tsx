    ...
    <div className="rounded-vf-md border border-vf-paper-border p-4">
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-3 lg:grid-cols-5">
        <Field label="Supplier" htmlFor="bill-supplier" required className="lg:col-span-2">
          {/* Finding #200 — a deactivated supplier no longer appears as
              a pick for a NEW document; an existing bill already tied
              to one still displays/edits fine elsewhere. Finding #167 —
              searchable Combobox instead of a plain Select. */}
                  ...
                  {isExpanded && (
                    <TableRow>
                      <TableCell colSpan={10} className="bg-vf-paper-alt/40">
                        ...
                        <div className="mt-3">
                          <DocumentsPanel companyId={companyId} entityType="SupplierBill" entityId={b.id} previewMode={previewMode} />
                        </div>
                      </TableCell>
                    </TableRow>
                  )}
