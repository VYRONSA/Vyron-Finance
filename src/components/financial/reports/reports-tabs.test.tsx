...
import { MOCK_BRANCHES, MOCK_COST_CENTRES, MOCK_DEPARTMENTS, MOCK_PROJECTS } from "@/lib/mock/company-management-data";
...
function renderTabs(previewMode = true) {
  return render(
    <ReportsTabs
      ...
      cashAccounts={MOCK_CHART_OF_ACCOUNTS.filter((a) => a.accountCode === "1000")}
