...
export function IconCornerDownLeft(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M20 4v7a3 3 0 0 1-3 3H5" />
...
export function IconEyeOff(props: IconProps) {
  return (
    <svg {...base} {...props}>
      <path d="M3 3l18 18" />
      <path d="M10.6 5.2A10.6 10.6 0 0 1 12 5c6.5 0 10 7 10 7a15.6 15.6 0 0 1-3.4 4.3M6.5 6.6C4 8.3 2 12 2 12s3.5 7 10 7a9.7 9.7 0 0 0 3.6-.7" />
