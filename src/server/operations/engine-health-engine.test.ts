...
describe("buildWorkflowEngineHealth", () => {
  function instance(overrides: Partial<WorkflowInstance>): WorkflowInstance {
    return { id: 1, companyId: "co_1", workflowDefinitionId: 1, subjectType: "X", subjectId: 1, currentStep: 0, status: "Pending", requestedBy: "System", createdAt: "2026-01-01T00:00:00Z", ...overrides };
  }
