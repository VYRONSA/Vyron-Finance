...
/** Finding #118 — the Sales/Purchasing transactional document types
 * (Quotation through to Supplier Bill) never had this platform wired in
 * at all, even though the storage/virus-scan/versioning/permission
 * infrastructure below is generic and already fully built — pure wiring,
...
export const DOCUMENT_PERMISSION_MODULE: Record<DocumentEntityType, PermissionModule> = {
  ...
  GoodsReceivedNote: "Purchasing",
  SupplierBill: "Purchasing",
};
