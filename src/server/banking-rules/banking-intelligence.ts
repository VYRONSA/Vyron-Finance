...
/** Exported for reuse by other pure detectors needing the same
 * beneficiary-identity comparison (e.g. recurring-transaction-detector.ts)
 * — trim+lowercase exact match, deliberately not fuzzy. */
export function normalizedBeneficiary(name: string): string {
