...
export type BankReconciliation = {
  ...
  /** The statement period's END date. `statementPeriodStart` is its
   * start — nullable because reconciliations created before migration
   * 0092 genuinely have no recorded start, and inventing one would
   * fabricate a fact about a completed reconciliation. */
