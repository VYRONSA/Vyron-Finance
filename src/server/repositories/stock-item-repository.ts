...
// Finding #058 — exported so callers can disclose when the real Stock
// Master exceeds this cap (mirrors CASHBOOK_TRANSACTIONS_LIST_CAP's
// `entriesCapped` pattern), since client-side search over the fetched
// array otherwise silently omits anything past this limit.
