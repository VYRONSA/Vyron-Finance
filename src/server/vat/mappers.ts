...
export function vatReturnFromRow(row: VatReturnRow): VatReturn {
  return {
    ...
    broughtForward: Number(row.brought_forward),
...
export function vatPaymentFromRow(row: VatPaymentRow): VatPayment {
  return {
    id: row.id,
    companyId: row.company_id,
    vatReturnId: row.vat_return_id,
