...
export function buildCashFlowStatement(
  ...
  // must sort numerically ascending everywhere, same fix as Phase 30/30A.
  operatingLines.sort((a, b) => compareGlAccountCodes(a.accountCode || "", b.accountCode || ""));
  financingLines.sort((a, b) => compareGlAccountCodes(a.accountCode, b.accountCode));
