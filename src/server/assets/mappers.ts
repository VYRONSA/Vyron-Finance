...
export type AssetClassRow = {
  ...
  is_active: boolean;
  created_at: string;
  gl_asset_account_code: string | null;
  gl_accumulated_depreciation_account_code: string | null;
  gl_depreciation_expense_account_code: string | null;
  gl_accumulated_impairment_account_code: string | null;
  gl_gain_on_disposal_account_code: string | null;
  gl_loss_on_disposal_account_code: string | null;
};
...
export function assetClassFromRow(row: AssetClassRow): AssetClass {
  return {
    ...
    glAssetAccountCode: row.gl_asset_account_code,
    glAccumulatedDepreciationAccountCode: row.gl_accumulated_depreciation_account_code,
    glDepreciationExpenseAccountCode: row.gl_depreciation_expense_account_code,
    glAccumulatedImpairmentAccountCode: row.gl_accumulated_impairment_account_code,
    glGainOnDisposalAccountCode: row.gl_gain_on_disposal_account_code,
    glLossOnDisposalAccountCode: row.gl_loss_on_disposal_account_code,
  };
}
